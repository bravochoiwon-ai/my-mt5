...
/* ---------------- 웹툰 (네이버 웹툰 기준) ---------------- */
const WEBTOON_GENRES = ["로맨스", "판타지", "액션", "무협/사극", "일상", "개그", "드라마", "감성", "스릴러", "스포츠"];

/* 웹툰 특성 6축 (1~5) — 웹툰마다 직접 매김 → 상세 레이더 + '웹툰 취향 결' */
const WEBTOON_AXES = ["작화", "스토리", "몰입도", "연출", "캐릭터", "독창성"];

/* 장르별 특성 — (참고용) */
const WEBTOON_TRAITS = {
  "로맨스": ["설렘·케미", "감정선", "달달함", "일상툰"],
  "판타지": ["세계관", "작화", "성장 서사", "몰입감"],
  "액션": ["박진감", "전투 연출", "작화", "성장"],
  "무협/사극": ["시대극", "무공 액션", "서사", "분위기"],
  "일상": ["공감", "소소함", "힐링", "잔잔함"],
  "개그": ["유머", "병맛", "가벼움", "빵 터짐"],
  "드라마": ["서사", "감정 몰입", "현실감", "캐릭터"],
  "감성": ["여운", "분위기", "감정선", "잔잔함"],
  "스릴러": ["긴장감", "반전", "서스펜스", "몰입감"],
  "스포츠": ["열정", "성장", "팀워크", "박진감"],
};
